...
public class createVccCustomer {
    ...
    public void create(Map<String, String> map, Boolean isDelMobileSign, SqlSession vccSession){
        cui = new createUserInfo();
        pcService = new p2p_customerService();
        VccCustomerService = new vcc_customerService();
        //添加虚拟信用卡的用户表
        VccCustomerService.addVccCustomerService(map, isDelMobileSign, vccSession);
    }
}
